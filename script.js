...
function startTimer() {
  //Sets time remaing based on input
...
//Converting seconds to string of MM:SS format
...
function updateMove() {
  ...
  if (selectedTile && selectedNum) {
    //Set the tile to the selected number
    selectedTile.textContent = selectedNum.textContent;
    //If the number matches to the corresponding number in the solution key
    if (checkCorrect(selectedTile)) {
      ...
      setTimeout(function () {
        ...
        selectedTile.classList.remove("selected");
        selectedNum.classList.remove("selected");
        //clear tiles text and clear selected variable
